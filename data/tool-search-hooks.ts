...
import { satelliteCalculators as satelliteTools } from "./satellite-course";
import { rfCalculators as rfTools } from "./rf-calculators";
...
export type ToolSearchHook = {
  ...
  reviewedOn: "2026-09-15" | "2026-09-16" | "2026-09-18";
};
...
const richToolSearchHooks = {
  "smps-designer": {
    ...
    metaDescription:
      "Estimate a first-pass DCM flyback SMPS operating point, transformer ratio, peak current, duty cycle, and switch stress for AC or DC input supplies.",
    ...
    scenario: {
      title: "Start with the energy path",
      description:
    ...
    questions: [
      {
        question: "Is this enough to build a mains-powered SMPS?",
        answer:
      ...
      {
        question: "Why does switching frequency change the transformer design?",
        answer:
      ...
      {
        question: "What should I verify in a controller datasheet?",
        answer:
    ...
    cta: {
      title: "Need a power stage reviewed as part of a prototype?",
      description:
  ...
  "buck-converter-designer": {
    ...
    metaDescription:
      "Estimate buck converter duty cycle, inductor, output capacitor, ripple current, peak current, and first-pass power loss from your design targets.",
    ...
    scenario: {
      title: "Size from ripple, then check the parts",
      description:
    ...
    questions: [
      {
        question: "Can I use the nearest standard inductor value?",
        answer:
      ...
      {
        question: "Why is the ceramic capacitor's printed value not enough?",
        answer:
      ...
      {
        question: "Does a correct calculation guarantee a stable converter?",
        answer:
    ...
    cta: {
      title: "Building a battery or DC-powered device?",
      description:
  ...
  "control-design-assistant": {
    ...
    metaDescription:
      "Describe the memory or state behavior you need and compare flip-flops, counters, registers, and shift registers with a live state table.",
    primaryQuestion:
    ...
    scenario: {
      title: "Begin with what the output must remember",
      description:
    ...
    questions: [
      {
        question: "Do I need a flip-flop or a latch?",
        answer:
      ...
      {
        question: "When should I use a counter instead of several flip-flops?",
        answer:
      ...
      {
        question: "What does a shift register solve?",
        answer:
    ...
    cta: {
      title: "Need to turn control behavior into electronics?",
      description:
  ...
  "logic-gate-designer": {
    ...
    metaDescription:
      "Set digital input conditions and generate a logic-gate network with its complete truth table for learning and early control-circuit design.",
    primaryQuestion:
    ...
    scenario: {
      title: "Define the output row by row",
      description:
    ...
    questions: [
      {
        question: "Should I build the result with gates or a microcontroller?",
        answer:
      ...
      {
        question: "Can a logic gate drive a relay directly?",
        answer:
      ...
      {
        question: "Why might a correct truth table still fail on hardware?",
        answer:
    ...
    cta: {
      title: "Have a control requirement but no circuit yet?",
      description:
  ...
  "cascaded-opamp-gain-designer": {
    ...
    metaDescription:
      "Split a target gain across inverting or non-inverting op-amp stages, calculate resistor ratios, and inspect the complete cascaded circuit.",
    ...
    scenario: {
      title: "Share gain without losing bandwidth",
      description:
    ...
    questions: [
      {
        question: "Why use two stages instead of one high-gain stage?",
        answer:
      ...
      {
        question: "Will the calculated output voltage always be available?",
        answer:
      ...
      {
        question: "Can I choose any resistor pair with the correct ratio?",
        answer:
    ...
    evidence: {
      ...
      href: "/work/embedded-iot/muscle-activity-monitoring/"
    },
    cta: {
      title: "Need a sensor signal chain sized for real hardware?",
      description:
  ...
  "555-timer-astable-circuit-calculator": {
    ...
    metaDescription:
      "Calculate NE555 astable frequency, high time, low time, and duty cycle from two resistors and one timing capacitor with a live waveform.",
    primaryQuestion: "How do I calculate 555 astable frequency and duty cycle?",
    directAnswer:
      "Enter the two timing resistors and capacitor to calculate a standard 555 astable oscillator's high time, low time, frequency, and duty cycle. The live behavior view shows how the capacitor charges and discharges. Use datasheet limits and measured component values when frequency accuracy, output loading, temperature, or a near 50 percent duty cycle matters.",
    usefulFor: [
      "Choosing first-pass timing components for a free-running 555 oscillator",
      "Seeing how R1, R2, and C affect high time, low time, and duty cycle"
    ],
    outputs: [
      "Oscillation frequency, period, high time, and low time",
      "Duty cycle and a live charge-discharge waveform"
    ],
    limitations: [
      "The equation assumes the standard astable connection and ideal threshold fractions",
      "Real timing shifts with component tolerance, leakage, supply conditions, temperature, and the specific bipolar or CMOS timer"
    ],
    scenario: {
      title: "Tune timing with the components you can buy",
      description:
        "Calculate a starting combination, then substitute available resistor and capacitor values and recalculate. Check minimum resistance, output loading, capacitor leakage, and frequency limits in the selected 555 datasheet."
    },
    questions: [
      {
        question: "Can the standard 555 astable circuit produce exactly 50 percent duty cycle?",
        answer:
          "The standard two-resistor connection keeps the charge path longer than the discharge path, so its duty cycle stays above 50 percent. Modified diode paths or other oscillator topologies can separate the timings."
      },
      {
        question: "Should I use a bipolar NE555 or a CMOS timer?",
        answer:
          "Choose from supply voltage, current consumption, input thresholds, output drive, timing range, and leakage. CMOS versions often suit low-power or long-time-constant designs, but the datasheet decides."
      },
      {
        question: "Why does my measured frequency differ from the calculation?",
        answer:
          "Resistor and capacitor tolerances, capacitor leakage, breadboard capacitance, supply variation, timer thresholds, and measurement loading all move the real frequency."
      }
    ],
    evidence: {
      title: "Smart Mosque Model",
      description:
        "This project shows sensor-triggered automation and energy control in a physical model. It is adjacent control-system evidence, not a claim that the project uses a 555 oscillator.",
      href: "/work/embedded-iot/smart-mosque-model/"
    },
    cta: {
      title: "Need timing behavior inside a larger control circuit?",
      description:
        "Send the required pulse or frequency range, supply voltage, output load, accuracy, and operating conditions to compare a 555, logic oscillator, or microcontroller timer.",
      href: "/contact/"
    },
    reviewedOn
  },
  "pid-simulator": {
    ...
    metaDescription:
      "Change P, I, and D gains and watch rise time, overshoot, steady-state error, settling, and line-following behavior in a live control simulation.",
    ...
    scenario: {
      title: "Tune one effect at a time",
      description:
    ...
    questions: [
      {
        question: "What does proportional gain change first?",
        answer:
      ...
      {
        question: "When should I add integral action?",
        answer:
      ...
      {
        question: "Why can derivative action become noisy?",
        answer:
    ...
    evidence: {
      ...
      href: "/work/embedded-iot/wireless-rov-control/"
    },
    cta: {
      title: "Need a controller connected to sensors and actuators?",
      description:
  ...
  "sensor-code-generator": {
    ...
    metaDescription:
      "Generate a runnable starting point for ESP32, Arduino, ESP-IDF, and PlatformIO sensors and communication interfaces with editable configuration.",
    ...
    scenario: {
      title: "Generate, wire, then prove one reading",
      description:
    ...
    questions: [
      {
        question: "Can I paste the generated code and connect any module with the same name?",
        answer:
      ...
      {
        question: "Why does an I2C sensor fail even when the code compiles?",
        answer:
      ...
      {
        question: "What should I add before using generated code in a product?",
        answer:
    ...
    cta: {
      title: "Need the generated driver integrated into a complete device?",
      description:
  ...
  "battery-estimator": {
    ...
    metaDescription:
      "Estimate ESP32 battery life, average current, energy per cycle, Wi-Fi cost, and active duty cycle from realistic operating phases.",
    ...
    scenario: {
      title: "Measure the phases that dominate",
      description:
    ...
    questions: [
      {
        question: "Why is a development board worse than a bare ESP32 module in sleep?",
        answer:
      ...
      {
        question: "Does battery capacity in mAh stay constant for every load?",
        answer:
      ...
      {
        question: "How should I model Wi-Fi reconnection?",
        answer:
    ...
    evidence: {
      ...
      href: "/work/embedded-iot/fall-detection-system/"
    },
    cta: {
      title: "Need a battery budget for a portable IoT prototype?",
      description:
  ...
  "ai-script-generator": {
    ...
    metaDescription:
      "Generate a structured Python project for object detection, segmentation, depth, classification, sensor AI, or classical machine learning.",
    ...
    scenario: {
      title: "Prove the data and execution path first",
      description:
    ...
    questions: [
      {
        question: "Will every generated project train a model?",
        answer:
      ...
      {
        question: "Should I begin with the largest model available?",
        answer:
      ...
      {
        question: "How do I know whether the model is ready for edge deployment?",
        answer:
    ...
    evidence: {
      ...
      href: "/work/apps-ui/plant-care-ai/"
    },
    cta: {
      title: "Need an AI model connected to sensors or an application?",
      description:
...
function boundedTitle(title: string): string {
  ...
  return (
    candidates.find((candidate) => candidate.length >= 35 && candidate.length <= 65) ??
...
function evidenceFor(tool: PublicTool): ToolSearchHook["evidence"] {
  if (tool.slug === "security-command-builder")
    return {
      title: "Multi-MCU Security Lock",
      description:
        "See a hardware access-control system where authorization, inputs, outputs, and failure behavior must remain explicit.",
      href: "/work/embedded-iot/multi-mcu-security-lock/"
    };
  if (["Text & Encoding", "Number Systems", "Conversions"].includes(tool.category))
    return {
  ...
  if (tool.category === "Physics & Math")
    return {
      title: "Human Follower Car",
      description:
        "See a mobile robot where measured distance, motion, sensing, and control calculations meet physical hardware.",
      href: "/work/robotics/human-follower-car/"
    };
  if (tool.category === "Control Design")
    return {
      title: "ToolGuard",
      description:
        "See how state, availability, identity, and outputs become a complete embedded control workflow.",
      href: "/work/embedded-iot/toolguard/"
    };
  if (tool.slug === "gradify")
    return {
      title: "AgriBot system architecture",
      description:
...
function limitationsFor(tool: PublicTool): string[] {
  if (["Text & Encoding", "Number Systems"].includes(tool.category))
    return [
  ...
  if (["Conversions", "Physics & Math"].includes(tool.category))
    return [
...
function buildGeneratedHook(tool: PublicTool): ToolSearchHook {
  ...
  const directAnswer =
    seed.directAnswer ??
    `${normalizeCopy(tool.summary)} Enter the known values and inspect the result immediately. For example, ${seed.example} Use the output to check your reasoning or shortlist a design, then verify the units, assumptions, and real-world limits that apply.`;
  return {
    slug: tool.slug,
...
const publicTools: PublicTool[] = [
  ...satelliteTools.map((tool) => ({
    slug: `satellite-${tool.slug}`,
    title: tool.title,
  ...
  ...engineeringTools.map((tool) => ({
    ...
    category: ("category" in tool ? tool.category : undefined) ?? "Engineering workbench"
  }))
];
...
const specialistSearchHooks = Object.fromEntries(
  publicTools
    .filter((t) => t.slug.startsWith("satellite-") || t.slug.startsWith("rf-"))
    .map((tool) => {
      const topic = [...satelliteTools, ...rfTools].find((t) =>
        tool.slug === `satellite-${t.slug}` || tool.slug === `rf-${t.slug}`
      );
      const subjects: string[] = topic?.topics ?? [
        "Orbits and RF propagation",
        "Noise and link budgets",
        "Engineering assumptions"
      ];
      const answer =
        topic?.lessons[0]?.text ??
        "Follow the satellite communication course from fundamentals and orbits through antennas, RF paths, noise, link budgets and multiple access. Use worked calculations, laboratory rehearsal and exam practice to check your understanding.";
      const hook: ToolSearchHook = {
        slug: tool.slug,
        seoTitle: boundedTitle(tool.title),
        metaDescription: boundedDescription(tool.summary),
        primaryQuestion: `What can I calculate with the ${tool.title}?`,
        directAnswer: answer,
        usefulFor: subjects
          .slice(0, 3)
          .map((s) => `Calculating ${s.toLowerCase()} with engineering models`),
        outputs: [
          tool.summary,
          "Explanations, assumptions and links to related satellite calculators"
        ],
        limitations: [
          "Analytical engineering models do not replace measurements or a mission-specific design review.",
          "Spectrum permissions, launch operations and real satellite tracking are outside these calculators."
        ],
        scenario: { title: subjects[0], description: topic?.lessons[1]?.text ?? answer },
        questions: [
          { question: `Which topics does ${tool.title} cover?`, answer: subjects.join("; ") + "." },
          {
            question: `How should I check my work in ${tool.title}?`,
            answer:
              "Read the stated assumptions and source references, check units and independently repeat a worked example before relying on the result."
          },
          {
            question: `Does ${tool.title} operate real satellite equipment?`,
            answer:
              "No. This is a browser-based educational resource. It does not transmit RF signals, command spacecraft or certify a working link."
          }
        ],
        evidence: {
          title: "Related embedded-system engineering",
          description:
            "Aqua Sync is a separate connected-device project, not evidence of a satellite deployment.",
          href: "/work/embedded-iot/aqua-sync/"
        },
        cta: {
          title: "Discuss an engineering prototype",
          description:
            "Share the required behavior, interfaces and how you plan to test the result.",
          href: "/contact/"
        },
        reviewedOn: "2026-09-18"
      };
      return [tool.slug, hook];
    })
) as Record<string, ToolSearchHook>;
...
export function validateToolSearchHooks(): { valid: boolean; issues: string[] } {
  ...
  for (const [key, hook] of Object.entries(toolSearchHooks)) {
    ...
    if (!/^\/work\/[a-z0-9-]+\/[a-z0-9-]+\/$/.test(hook.evidence.href))
      issues.push(`${key}: evidence must use an internal project URL`);
    if (hook.cta.href !== "/contact/") issues.push(`${key}: CTA must lead to /contact/`);
    if (hook.seoTitle.length < 35 || hook.seoTitle.length > 65)
      issues.push(`${key}: SEO title must be 35 to 65 characters`);
    if (hook.metaDescription.length < 120 || hook.metaDescription.length > 165)
      issues.push(`${key}: meta description must be 120 to 165 characters`);

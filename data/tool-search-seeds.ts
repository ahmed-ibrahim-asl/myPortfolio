...
const rawToolSearchSeeds: Record<string, ToolSearchSeed | readonly [string, string]> = {
  ...
  "vigenere-cipher": ["Vigenere and Autokey cipher encoder and decoder", "Encode ATTACKATDAWN with keyword LEMON to get LXFOPVEFRNHR, then decode it back."],
  "affine-cipher": ["affine cipher encoder and decoder", "Encode AFFINECIPHER with a=5 and b=8 to get IHHWVCSWFRCP, then decode it back."],
  "transposition-cipher": ["rail fence and row transposition cipher encoder and decoder", "Encode WEAREDISCOVEREDFLEEATONCE on 3 rails to get WECRLTEERDSOEEFEAOCAIVDEN, then decode it back."],
  "playfair-cipher": ["Playfair cipher encoder and decoder", "Encode HIDETHEGOLDINTHETREESTUMP with keyword PLAYFAIR EXAMPLE to get BMODZBXDNABEKUDMUIXMMOUVIF."],
  "hill-cipher": ["Hill cipher encoder and decoder", "Encode PAYMOREMONEY with the 3x3 key 17 17 5 21 18 21 2 2 19 to get LNSHDLEWMTRW."],
  "hash-generator": ["MD5 SHA1 SHA256 hash generator", "Hash the text abc to see MD5 900150983cd24fb0d6963f7d28e17f72 and SHA-256 ba7816bf8f01cfea414140de5dae2223b00361a396177a9cb410ff61f20015ad."],
  "aes-hex-calculator": ["AES hex encryption and decryption calculator", "Encrypt hex block 00112233445566778899aabbccddeeff with the FIPS-197 test key 000102030405060708090a0b0c0d0e0f to get 69c4e0d86a7b0430d8cdb78070b4c55a."],

...
export default async function ArabicRfTool({params}){const {slug}=await params;if(!rfCalculators.some(item=>item.slug===slug))notFound();return <SatelliteWorkspace slug={slug} routeRoot="rf" locale="ar"/>;}

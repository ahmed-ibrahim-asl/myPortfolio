...
export default async function ArabicSatelliteTool({params}){const {slug}=await params;if(!satelliteCalculators.some(item=>item.slug===slug))notFound();return <SatelliteWorkspace slug={slug} routeRoot="satellite" locale="ar"/>;}
